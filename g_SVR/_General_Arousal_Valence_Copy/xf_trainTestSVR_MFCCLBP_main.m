...
SMOOTH_RESULT_MFCCLBP = [mse.^0.5 q ccc]

predicted = predictedAV;
save('mfcclbp.mat','actual','predicted')
...
RAW_RESULT_MFCCLBP = [mse.^0.5 q ccc]

predicted = predictedAV;
save('mfcclbpraw.mat','actual','predicted')
