...
fTrainAV = fopen('za_AudioVideo_Train.txt','r'); %fTrainV = fopen('FinalVideoTrain.txt'); 
...
while ischar(tlineAV)
	c = c + 1;
    %tlineAV = 'AudioVideoFeaturesArousal/P64/AudioVideo26600Feature.mat 0.11675 0.13674 0.18649 0.072348';
...
SMOOTH_RESULT_AV = [mse.^0.5 q ccc]

predicted = predictedAV;
save('audiovideo.mat','actual','predicted')
...
RAW_RESULT_AV = [mse.^0.5 q ccc]

predicted = predictedAV;
save('audiovideoraw.mat','actual','predicted')
